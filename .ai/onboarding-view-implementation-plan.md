...
- **Endpoint:** `POST /api/ai/calculate-tdee` (bazując na strukturze plików) lub własna implementacja w utilach, jeśli endpoint nie jest publiczny. _Zgodnie z PRD system ma wyliczać, więc zakładamy strzał do API._
