...
- **Spójność danych:** Zmiana danych w zakładce Profil (np. Data urodzenia -> Wiek) powinna wpływać na wyniki Kalkulatora w zakładce Cele. Dlatego `ProfileView` musi przekazywać _zaktualizowany_ obiekt profilu do `DietaryGoalsForm`.
